...
- **zamanlanmis gorev**: `IkinciBeyin-YatirimRaporu`, hafta ici 19:00, `gunluk.ps1` calistirir. Python'un TAM yolu betige gomulu - gorev farkli PATH ile calisir, `python` komutu bulunamaz.
